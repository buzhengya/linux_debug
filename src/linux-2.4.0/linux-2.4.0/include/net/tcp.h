...
struct tcp_bind_hashbucket {
	spinlock_t		lock;
	struct tcp_bind_bucket	*chain; // bind hash bucket. list store all same hash port
};
...
extern struct tcp_hashinfo {
	 ...
	 */
	struct tcp_bind_hashbucket *__tcp_bhash; // array storage all bind hash bucket. every bucket is list 
